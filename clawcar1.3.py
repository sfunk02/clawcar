...
while True:
    ...
    if fuzzy_pulse_compare(p1, detected) and myServo1.angle < 170:       #Moves lower arms forward
        print('1')
    ...
    if fuzzy_pulse_compare(p2, detected) and myServo3.angle > 30: #Moves upper arm down
        print('2')
